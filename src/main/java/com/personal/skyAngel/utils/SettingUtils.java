...
import com.personal.skyAngel.config.common.EnumConverter;
...
public final class SettingUtils {
    ...
    public static Setting get() {
        ...
        try {
            InputStream configIS = new ClassPathResource(CommonAttributes.COMMON_CONFIG_XML_PATH).getInputStream();
            Document document = new SAXReader().read(configIS);
            List<Element> elements = document.selectNodes("/jlr/setting");
