...
public class DateTimeUtils implements Serializable {
    ...
    public static final SimpleDateFormat shortCompactDateFormat = new SimpleDateFormat("yyyyMMdd");
     ...
     * @return
     */
    public static Date getSpecifyTimeForDate(Date date, Integer year, Integer month, Integer day, Integer hour,
            Integer min, Integer second) {
        if (date == null) {
            return null;
        }
        Calendar calendar = Calendar.getInstance();
    ...
    /**
     * string 类型 "yyyyMMdd" 与 "yyyy-MM-dd" 时间日期转换
     *
     * @param inputType 输入数据类型 。 仅限 "yyyyMMdd" 与 "yyyy-MM-dd"
     * @param outputType 输出数据类型。 仅限 "yyyyMMdd" 与 "yyyy-MM-dd" 类型
     */
    public static String dateConversion(String data, String inputType, String outputType) throws ParseException {
        if (StringUtils.isEmpty(data) || StringUtils.isEmpty(inputType) || StringUtils.isEmpty(outputType)) {
            return null;
        }
        if ("yyyyMMdd".equals(inputType) & "yyyy-MM-dd".equals(outputType)) {
        ...
        if ("yyyy-MM-dd".equals(inputType) & "yyyyMMdd".equals(outputType)) {
